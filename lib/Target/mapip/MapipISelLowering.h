...
#ifndef LLVM_TARGET_MAPIP_MAPIPISELLOWERING_H
#define LLVM_TARGET_MAPIP_MAPIPISELLOWERING_H
...
namespace llvm {
  ...
  namespace MapipISD {
    enum NodeType {
      ...
      /// OPC is the branch opcode to use (e.g. Mapip::BEQ),
...
#endif   // LLVM_TARGET_MAPIP_MAPIPISELLOWERING_H
